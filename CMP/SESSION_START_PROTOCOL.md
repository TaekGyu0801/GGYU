...
### 가장 마지막으로 한 작업
TEAM_TIMELINE / 개인 TIMELINE / LIVE LOG의 최신 기록을 기준으로,
팀 또는 해당 작업자가 **제일 마지막에 실제로 한 작업**을 1~3줄로 요약한다.
제안만 있었던 경우에는 PROPOSED임을 명시한다.
...
사용자가 새 채팅에서 `이택규` 또는 `주수빈`이라고 시작하면,
첫 답변은 항상 아래 5가지를 포함한다.

1. 현재까지 진행 상황
2. 가장 마지막으로 한 작업
3. 현재 blocker
4. 다음 작업
5. CMP 대시보드 링크: https://taekgyu0801.github.io/GGYU/
